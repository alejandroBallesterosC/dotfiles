...
- When writing markdown files, CLAUDE.md, AGENTS.md, and other forms of code documentation avoid writing referring to temporal context about refactors or recent changes. Documentation should be evergreen and describe the current functionality, expected behavior, and state of the code as it is, not how it evolved or was recently changed.
...
- Tests must be passed by implementing the intended functionality in good faith; not reward hacking.
